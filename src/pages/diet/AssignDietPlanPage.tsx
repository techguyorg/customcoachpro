...
export function AssignDietPlanPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-3xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-display font-bold">Assign diet plan</h1>
          <p className="text-muted-foreground">Choose a client and start date for {plan?.name ?? "this plan"}.</p>
        </div>
      </div>
        ...
        <CardContent>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end gap-3">
              <Button type="button" variant="outline" onClick={() => navigate("/diet-plans")}>Cancel</Button>
